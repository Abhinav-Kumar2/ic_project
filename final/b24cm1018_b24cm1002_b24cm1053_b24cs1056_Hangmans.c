...
#include <stdlib.h>
#include <string.h>
#include "b24cm1018_b24cm1002_b24cm1053_b24cs1056_Hangman_Word.h" // Include the header file with word list
...
int main() {
    ...
    if (correct_guess_no == lengthOfWord) {
		...
		FILE *fp = fopen("b24cm1018_b24cm1002_b24cm1053_b24cs1056_datastorage.txt", "a");
		fputs("2\n", fp);
		fclose(fp);
